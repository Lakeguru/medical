            ...
            <div class="col-lg-8 col-md-12 left-box">
                ...
                <div class="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div class="body">
                        ...
                        <ul class="meta">
                            <li><a href="#"><i class="zmdi zmdi-account col-blue"></i>Posted By: John Smith</a></li>
                            <li><a href="#"><i class="zmdi zmdi-label col-lime"></i>Traumatology</a></li>
                            <li><a href="#"><i class="zmdi zmdi-comment-text col-blue"></i>Comments: 18</a></li>
                        </ul>
                    </div>
                    <div class="body">
                        <div class="img-post m-b-15">
                ...
                <div class="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div class="body">
                        ...
                        <ul class="meta">
                            <li><a href="#"><i class="zmdi zmdi-account col-blue"></i>Posted By: John Smith</a></li>
                            <li><a href="#"><i class="zmdi zmdi-label col-green"></i>Cardiology</a></li>
                            <li><a href="#"><i class="zmdi zmdi-comment-text col-blue"></i>Comments: 8</a></li>
                        </ul>
                    </div>
                    <div class="body">
                        <div class="img-post m-b-15">
